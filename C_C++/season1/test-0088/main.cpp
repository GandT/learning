...
#define TAMA_MAX 128
int SikakuX , SikakuY , SikakuMuki , SikakuJoutai =0, SikakuW ,SikakuH ;
					 ...
					 LPSTR lpCmdLine, int nCmdShow )
{
	...
	// 四角君のグラフィックをメモリにロード＆表示座標をセット
	 LoadDivGraph( "クラッカー.bmp" ,3,3,1,64,64,CrackerGraph) ;
	...
	GetGraphSize( CrackerGraph[0] , &SikakuW , &SikakuH );
...
//		}
		...
		// 四角君の移動ルーチン
		{
			...
			// 四角君を描画
			if(SikakuJoutai>299)SikakuJoutai = 299;
			DrawGraph( SikakuX , SikakuY , CrackerGraph[SikakuJoutai/100] , true ) ;
		}
